...
function list1() {
    return new Promise(async (resolve) => {
                ...
                let options = {
    url: `https://api.m.jd.com/client.action?functionId=mcxhd_brandcity_taskList&appid=publicUseApi&body=%7B%22lat%22:%2229.96957%22,%22lng%22:%22106.286797%22,%22token%22:%22jd17919499fb7031e5%22%7D&t=1623803136803&client=wh5&clientVersion=1.0.0&sid=8c1579b24a9637227a469e59512ab53w&uuid=7049442d7e415231&area=4_48201_54794_0&networkType=wifi`,
        ...
        $.get(options, async (err, resp, data) => {
            try {
                    ...
                    data = JSON.parse(data);
                     ...
                     await dotask(itemToken)  }    
                     let taskList3 = data.result.tasks[3].subItem 
                     for (let i = 0 ; i < taskList3.length; i++){
                     itemToken = taskList3[i].itemToken
                     await dotask(itemToken)  }  
...
function game() {
    return new Promise(async (resolve) => {
                ...
                let options = {
    url: `https://api.m.jd.com/client.action?functionId=mcxhd_brandcity_reportGame&appid=publicUseApi&body={"token":"jd17919499fb7031e5","score":100}&t=1623805712779&client=wh5&clientVersion=1.0.0&sid=8c1579b24a9637227a469e59512ab53w&uuid=7049442d7e415231&area=4_48201_54794_0&networkType=wifi`,
        ...
        $.get(options, async (err, resp, data) => {
            try {
                    ...
                    if(data.retCode == 200){
                               ...
                               $.log(`\n抽取京豆：${data.result.gift.jbeanNum}`)
...
function dotask(itemToken) {
    return new Promise(async (resolve) => {
                ...
                let options = {
    url: `https://api.m.jd.com/client.action?functionId=mcxhd_brandcity_doTask&appid=publicUseApi&body={"itemToken":"${itemToken}","token":"jd17919499fb7031e5"}&t=1623804134260&client=wh5&clientVersion=1.0.0&sid=8c1579b24a9637227a469e59512ab53w&uuid=7049442d7e415232&area=4_48201_54794_0&networkType=wifi `,
