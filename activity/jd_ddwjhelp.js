...
================Loon==============
[Script]
cron "40 1 * * *" script-path= https://raw.githubusercontent.com/Ariszy/Private-Script/master/JD/zy_ddwj.js,tag= 东东玩家
===============Surge=================
...
async function control(){
    console.log("助力次数："+list1tokenArr.distinct().length)
 ...
 return new Promise((resolve) => {
    ...
    try{
        ...
        if(result.code == 0){
            ...
            $.log("邀请码："+list5.assistTaskDetailVo.taskToken)
