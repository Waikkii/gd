...
const Faker = require('./JDJRValidator')
  ...
  switch (stop) {
    case 0:
      ...
      await Promise.all([
        ...
        JDUserSignPre(stop, 'ReceiveJD', '京东商城-领京豆', 'Ni5PUSK7fzZc4EKangHhqPuprn2'), //京东领京豆
    ...
    default:
      ...
      await JDUserSignPre(Wait(stop), 'ReceiveJD', '京东商城-领京豆', 'Ni5PUSK7fzZc4EKangHhqPuprn2'); //京东领京豆
