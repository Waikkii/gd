...
let cookiesArr = [];
const activityList = [
    {'activityId':'e23a262b02fc4e279f5a0fc3a5764ac6','endTime':null},
    {'activityId':'85201aaf1895431e874132d9c2669afe','endTime':null},
    {'activityId':'30ed2348398c4f4796e585b9b5240a28','endTime':null},
    {'activityId':'98c5481d6f0544648b2af2db2c933eb4','endTime':null},
];
$.UA = '';
if ($.isNode()) {
...
async function getReward(){
    ...
    const headers = {
        ...
        'User-Agent' : $.UA,
        'Referer' : `https://prodev.m.jd.com/mall/active/45As2RxLNvQaLGH4fTDRNETvA4fV/index.html`,
    ...
    return new Promise(async resolve => {
        const options = {
            ...
            "headers": {
                ...
                "User-Agent": $.isNode() ? (process.env.JD_USER_AGENT ? process.env.JD_USER_AGENT : (require('../scripts/USER_AGENTS').USER_AGENT)) : ($.getdata('JDUA') ? $.getdata('JDUA') : "jdapp;iPhone;9.4.4;14.3;network/4g;Mozilla/5.0 (iPhone; CPU iPhone OS 14_3 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148;supportJDSHWK/1")
            }
        }
