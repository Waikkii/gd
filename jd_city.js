...
let insertCodes = ['RtGKzbmnQAr3K4ucQYIyh8mMI-N3N8gyXfJIyFy20lOJehl-gg', 'RtGKzu6gSFyre9WYRdBl0qMhOfJnB9WuyTh2ZFgJl4kSwZfbmQ', 'RtGKzO-jRF-mK4uSH9Zl1buKVx_cHwN3xaxN--X2KQ9ainy7rg'];
let inviteCodes = []
!(async () => {
    if (!cookiesArr[0]) {
        ...
        for (let code of insertCodes) {
            ...
            if (res && res['data'] && res['data']['bizCode'] === 0) {
                ...
                if (res['data']['result']['toasts'] && res['data']['result']['toasts'][0]) {
                    console.log(`助力 呆瓜【${code}】:${res.data.result.toasts[0].msg}`)
                }
            }
