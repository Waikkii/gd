...
# repo5='Wenmoux_scripts_wen_chinnkarahoi'           #预设的 Wenmoux 仓库，用于读取口袋书店互助码。需提前拉取温某人的仓库或口袋书店脚本并完整运行7
# repo6='Aaron-lv_sync_jd_scripts'                   #预设的 Aaron-lv 仓库
repo='Waikkii_gd'                                        #默认调用 Waikiki 仓库脚本日志
...
FixDependType="1"
## 定义监控修复的依赖名称
package_name="canvas png-js crypto-js form-data got"
